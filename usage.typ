...
#lab-table(
  ...
  environment: (
    os: [Windows 11],
    devtools: [VS Code],
    compiler: [g++ (Rev11, Built by MSYS2 project) 15.2.0],
  ),
  content: (
    (
      question: [程序改错-1],
  ...
  summary: (
    (
      title: [总结本次实验],
      content: [本次实验对CPP的基本语法进行了加深，对头文件以及关键字有相关认识，以及对命名空间相关的使用进行学习。],
    ),
    (
      title: [心得体会],
      content: [对CPP语言中的std库有了更深的认识，在编程中要更加注意namespace可能带来的问题，尽量少的使用全局引入。],
    ),
  ),
)
